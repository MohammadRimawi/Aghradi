...
<script src="app.js"></script>
    ...
    <div id="header">
        ...
        <div class=Container>
        <h3>Deliver with Aghradi</h3>
        <form action="AGHRADI.php" method="post">
            <button type=submit name=JoinTeam class="btn btn-primary fullHeight" style="position:relative; border-radius: 5px; font-size:20pt;">Join The Team Now!</button>
        </form>
        </div>
